...
(function() {
  ...
  this.audioPlayer = new AudioPlayerUI({
    ...
    songs: [
      {
        image: "img/audio1.png",
        name: "Yaari Chandigarh Waliye - Ranjit Bawa",
        srcs: [
          {
            src: "audio/Yaari Chandigarh Waliye - Ranjit Bawa (DjPunjab.Com).mp3",
            type: "audio/mp3"
          }
        ]
      }, 
      // {
      //   image: "img/sunhawk-small-2@2x.jpg",
  ...
  this.audioPlayer = new AudioPlayerUI({
    el: document.getElementById("audio-player2"),
    songs: [
      {
  ...
  this.audioPlayer = new AudioPlayerUI({
    el: document.getElementById("audio-player3"),
    songs: [
      {
        image: "img/audio3.png",
        name: "Yaari Chandigarh Waliye - Ranjit Bawa",
        srcs: [
          {
            src: "audio/Yaari Chandigarh Waliye - Ranjit Bawa (DjPunjab.Com).mp3",
  ...
  this.audioPlayer = new AudioPlayerUI({
    el: document.getElementById("audio-player4"),
    songs: [
      {
